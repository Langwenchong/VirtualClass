...
<script>
// import { delCommentService, updateCommentService } from './function/comment.js'
// import { formatDt } from './function/dt.js'
// import event from './function/event.js'
// import {getUserInfoService } from './function/user.js'

export default {
    props: ['data'],
    data() {
        return {
            circleUrl: "../../../assets/beayty.jpg",
            showEditModal: false,
            newContent: '',
            userInfo: {
                username: '',
    ...
    computed: {
        ...
        isMy() {
            ...
            return curData.userName === this.userInfo.username
        }
    },
    methods: {
        async update() {
